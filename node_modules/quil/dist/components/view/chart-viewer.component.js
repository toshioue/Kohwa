...
import { ChartDataVm } from '../viewmodel/chart-data-vm';
var ChartViewerComponent = /** @class */ (function () {
    function ChartViewerComponent() {
        this.lineData = new ChartDataVm();
        this.barData = new ChartDataVm();
        this.pieData = new ChartDataVm();
        this.douData = new ChartDataVm();
    }
    ChartViewerComponent.prototype.ngOnInit = function () {
        var dw = this.barDatas;
    };
    ChartViewerComponent.decorators = [
        { type: Component, args: [{
    ...
    /** @nocollapse */
    ChartViewerComponent.ctorParameters = function () { return []; };
    ChartViewerComponent.propDecorators = {
        'barDatas': [{ type: Input, args: ['barModel',] },],
        'lineDatas': [{ type: Input, args: ['lineModel',] },],
        'pieDatas': [{ type: Input, args: ['pieModel',] },],
        'douDatas': [{ type: Input, args: ['douModel',] },],
    };
    return ChartViewerComponent;
}());
export { ChartViewerComponent };
