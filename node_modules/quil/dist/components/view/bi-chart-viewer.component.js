...
var BIViewerComponent = /** @class */ (function () {
    function BIViewerComponent(cService) {
        this.cService = cService;
        this.group = "";
        this.chartDatas = [];
        cService.url = this.url;
    }
    BIViewerComponent.prototype.ngOnInit = function () {
        console.log(this);
        this.me = this;
        this.cService.url = this.url;
        this.cService.wsUrl = this.wsUrl;
    };
    BIViewerComponent.decorators = [
        { type: Component, args: [{
                    selector: 'bi-viewer',
    ...
    /** @nocollapse */
    BIViewerComponent.ctorParameters = function () { return [
        { type: BIService, },
    ]; };
    BIViewerComponent.propDecorators = {
        'wsUrl': [{ type: Input, args: ['wsUrl',] },],
        'url': [{ type: Input, args: ['url',] },],
        'bandsContainer': [{ type: ViewChild, args: ['bandsContainer',] },],
    };
    return BIViewerComponent;
}());
export { BIViewerComponent };
//# sourceMappingURL=bi-chart-viewer.component.js.map