                            ...
                            <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                                <ul class="nav navbar-nav menu_nav ml-auto">
                                    ...
                                    <li class="nav-item active">
                                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">PRESS RELEASE</a>
                                    </li>
            ...
            <div class="banner_inner d-flex align-items-center">
                ...
                <div class="container">
                    <div class="banner_content text-center">
                        ...
                        <p class="lead">Keep up with the latest news and events of KOHWA!</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div id="blog" class="blog_left_sidebar">
                          ...
                          <!--This is the number tabs  <nav class="blog-pagination justify-content-center d-flex">
		                        <ul class="pagination">
		                            <li class="page-item">
